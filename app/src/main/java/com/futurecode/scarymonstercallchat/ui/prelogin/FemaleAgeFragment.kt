...
import com.futurecode.scarymonstercallchat.databinding.FragmentFemaleAgeBinding

class FemaleAgeFragment : BaseFragment<FragmentFemaleAgeBinding>(FragmentFemaleAgeBinding::inflate) {
            ...
            if (selectedAgeId != null) {
                fullScreenAdsHelper.showInterstitialAds(true, object : AdInterface {
                    override fun finished() {
                        findNavController().navigate(R.id.action_femaleAgeFragment_to_welcomeFragment)
                    }
                })
            } else {
